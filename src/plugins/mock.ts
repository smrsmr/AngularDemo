...
const data:Array<any> = []; // 用于接受生成数据的数组
// eslint-disable-next-line no-unused-vars
const size:Array<any> = [
 ...
 */
function Data(current:number, pageSize:number, data:Array<any>) {
...
Mock.mock('/data/page', 'post', function (options:any) {
...
Mock.mock('/data/getchart', 'get', chartData); // 根据数据模板生成模拟数据